 ...
 */
let events = new Array(...new Set(gameEvents.values()));
// console.log(events);

/**
 * 2.
 * After the game has finished, it was found that the yellow card from minute 64 was unfair. So remove this event from the game events log. 
 */
